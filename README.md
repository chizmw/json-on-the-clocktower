...
![Version](https://img.shields.io/badge/latest-0.0.24-blue)
...
curl \
  ...
  --create-dirs \
  -o data/imported/clocktower.json \
  https://raw.githubusercontent.com/chizmw/json-on-the-clocktower/0.0.24/data/generated/roles-combined.json
```
